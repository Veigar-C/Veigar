...
<div data-role="page">
    ...
    <div data-role="content">
        <form action="selectDriver.do" method="post" data-ajax="false">
            <ul data-role="listview" data-inset="true">
                ...
                <li data-role="fieldcontain">
                    <label for="day">发动机号</label>
                    <input type="text" name="carEngineNum" id="fdj_num"/>
                </li>
                <li data-role="fieldcontain">
                    <label for="day">车架号</label>
                ...
                <li data-role="fieldcontain">
                    <input type="submit" value="提交" data-theme="b" onclick="return check()"/>
                </li>
            </ul>
        </form>
